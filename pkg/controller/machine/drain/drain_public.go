...
// This file contains examples on how to drain/cordon/uncordon nodes.
// These functions may be called directly, or their functionality
// copied into your own code, for example if you want different output
// behaviour.
