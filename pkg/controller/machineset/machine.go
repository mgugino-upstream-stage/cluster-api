...
func (c *ReconcileMachineSet) getMachineSetsForMachine(m *v1beta1.Machine) []*v1beta1.SmartMachineSet {
	if len(m.Labels) == 0 {
		klog.Warningf("No machine sets found for Machine %v because it has no labels", m.Name)
		return nil
	}

	msList := &v1beta1.SmartMachineSetList{}
	...
	var mss []*v1beta1.SmartMachineSet
...
func hasMatchingLabels(machineSet *v1beta1.SmartMachineSet, machine *v1beta1.Machine) bool {
